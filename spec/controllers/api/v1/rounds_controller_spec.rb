...
RSpec.describe Api::V1::UsersController, type: :controller do
  ...
  describe "GET#show" do
    it "should return the user and their details" do
      ...
      expect(returned_json["user"]["rounds"][0]["date"]).to eq "07/01/2019"
      expect(returned_json["user"]["rounds"][0]["course"]).to eq "Boston Golf Course"
      ...
      expect(returned_json["user"]["rounds"][1]["date"]).to eq "06/12/2019"
      expect(returned_json["user"]["rounds"][1]["course"]).to eq "Mt Hood Municipal Golf Course"
